...
//+kubebuilder:rbac:groups=redis.run,resources=redisclusterbackups,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=redis.run,resources=redisclusterbackups/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=redis.run,resources=redisclusterbackups/finalizers,verbs=update
