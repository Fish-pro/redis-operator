...
//+kubebuilder:webhook:path=/mutate-redis-run-v1alpha1-rediscluster,mutating=true,failurePolicy=fail,sideEffects=None,groups=redis.run,resources=redisclusters,verbs=create;update,versions=v1alpha1,name=mrediscluster.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-redis-run-v1alpha1-rediscluster,mutating=false,failurePolicy=fail,sideEffects=None,groups=redis.run,resources=redisclusters,verbs=create;update,versions=v1alpha1,name=vrediscluster.kb.io,admissionReviewVersions=v1
