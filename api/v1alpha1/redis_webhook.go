...
//+kubebuilder:webhook:path=/mutate-redis-run-v1alpha1-redis,mutating=true,failurePolicy=fail,sideEffects=None,groups=redis.run,resources=redis,verbs=create;update,versions=v1alpha1,name=mredis.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-redis-run-v1alpha1-redis,mutating=false,failurePolicy=fail,sideEffects=None,groups=redis.run,resources=redis,verbs=create;update,versions=v1alpha1,name=vredis.kb.io,admissionReviewVersions=v1
